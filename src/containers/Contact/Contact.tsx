      ...
      <address>
        ...
        <div className={styles.contact__media}>
          <div className={styles.contact__icon_box}>
            {isMobile() ? (
              <a
                href="tel:+77076467573"
                className={styles.contact__icon_phone}
              ></a>
            ) : (
          ...
          {isMobile() ? (
            <a
              href="tel:+77076467573"
              className={styles.contact__media_content}
            >
              +7(707)-646-75-73
            </a>
          ) : (
        ...
        <div className={styles.contact__media}>
          <div className={styles.contact__icon_box}>
            <a
              ...
              target={"_blank"}
              className={styles.contact__icon_message}
            ></a>
          </div>
          <a
            href="#"
            ...
            className={styles.contact__media_content}
          >
            bumerboy86@gmail.com
          </a>
        </div>
        <div className={styles.contact__media}>
          <div className={styles.contact__icon_box}>
            <a
              href="https://t.me/ruslan_voronov1986"
              className={styles.contact__icon_telegram}
            ></a>
          </div>
          <a
            href="https://t.me/ruslan_voronov1986"
        ...
        <div className={styles.contact__media}>
          <div className={styles.contact__icon_box}>
            <a
              href="https://wa.me/77076467573"
              className={styles.contact__icon_whatsapp}
            ></a>
          </div>
          <a
            href="https://wa.me/77076467573"
